                ...
                >
                  <div class="row row-30">
                    <div class="col-md-6">
                      <div class="form-wrap">
                        <?php
                        $formulaire->createInput('Name','form-input'); ?>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-wrap">
                        <?php $formulaire->createInput('Phone','form-input'); ?>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-wrap">
                      <?php $formulaire->createInput('Email','form-input'); ?>
                    ...
                    <div class="col-12">
                      <div class="form-wrap">
                      <?php $formulaire->createInput('Message','form-input'); ?>
